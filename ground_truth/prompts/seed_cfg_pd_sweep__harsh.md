# Ground-truth prompts — PD — payoff sweep (mild vs harsh)

- **config id:** `seed_cfg_pd_sweep`  •  **variant:** `harsh`
...
If you both choose OptionA, you both get a penalty of 8.
...
If you both choose OptionB, you both get a penalty of 5.
