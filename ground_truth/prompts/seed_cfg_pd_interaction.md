# Ground-truth prompts — PD — interaction graph (asymmetric visibility)

- **config id:** `seed_cfg_pd_interaction`
- **game_type:** `gt_pd`  •  **variation:** `comm`  •  **languages:** ['en']
- **run status:** ok
...
This is the history of the choices made so far: {'round_1': {'agent1': {'message': 'OptionA'}}}.
Choose between OptionA and OptionB.
Output ONLY the choice.
```
...
This is the history of the choices made so far: {'round_1': {'agent1': {'message': 'OptionA'}, 'agent2': {}}}.
Choose between OptionA and OptionB.
Output ONLY the choice.
```
...
This is the history of the choices made so far: {'round_1': {'agent1': {'message': 'OptionA'}, 'agent2': {'message': 'OptionA'}}}.
Choose between OptionA and OptionB.
Output ONLY the choice.
```

## 5. phase=`choose`  agent=`agent2`  model=`Claude Sonnet 4.6`  ×2
